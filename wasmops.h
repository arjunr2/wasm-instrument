...
#define WASM_OP_I32_REINTERPRET_F32                                            \
    0xBC /* "i32.reinterpret_f32", ImmSigs.NONE */
#define WASM_OP_I64_REINTERPRET_F64                                            \
    0xBD /* "i64.reinterpret_f64", ImmSigs.NONE */
#define WASM_OP_F32_REINTERPRET_I32                                            \
    0xBE /* "f32.reinterpret_i32", ImmSigs.NONE */
#define WASM_OP_F64_REINTERPRET_I64                                            \
    0xBF /* "f64.reinterpret_i64", ImmSigs.NONE */
...
#define WASM_OP_RETURN_CALL_INDIRECT                                           \
    0x13                      /* "return_call_indirect", ImmSigs.SIG_TABLE */
...
#define WASM_OP_V128_LOAD8_SPLAT 0xFD07 /* "v128.load8_splat", ImmSigs.MEMARG  \
                                         */
#define WASM_OP_V128_LOAD16_SPLAT                                              \
    0xFD08 /* "v128.load16_splat", ImmSigs.MEMARG */
#define WASM_OP_V128_LOAD32_SPLAT                                              \
    0xFD09 /* "v128.load32_splat", ImmSigs.MEMARG */
#define WASM_OP_V128_LOAD64_SPLAT                                              \
    0xFD0A /* "v128.load64_splat", ImmSigs.MEMARG */
...
#define WASM_OP_I8x16_EXTRACT_LANE_S                                           \
    0xFD15 /* "i8x16.extract_lane_s", ImmSigs.LANEIDX */
#define WASM_OP_I8x16_EXTRACT_LANE_U                                           \
    0xFD16 /* "i8x16.extract_lane_u", ImmSigs.LANEIDX */
#define WASM_OP_I8x16_REPLACE_LANE                                             \
    0xFD17 /* "i8x16.replace_lane", ImmSigs.LANEIDX */

#define WASM_OP_I16x8_EXTRACT_LANE_S                                           \
    0xFD18 /* "i16x8.extract_lane_s", ImmSigs.LANEIDX */
#define WASM_OP_I16x8_EXTRACT_LANE_U                                           \
    0xFD19 /* "i16x8.extract_lane_u", ImmSigs.LANEIDX */
#define WASM_OP_I16x8_REPLACE_LANE                                             \
    0xFD1A /* "i16x8.replace_lane", ImmSigs.LANEIDX */

#define WASM_OP_I32x4_EXTRACT_LANE                                             \
    0xFD1B /* "i32x4.extract_lane", ImmSigs.LANEIDX */
#define WASM_OP_I32x4_REPLACE_LANE                                             \
    0xFD1C /* "i32x4.replace_lane", ImmSigs.LANEIDX */
#define WASM_OP_I64x2_EXTRACT_LANE                                             \
    0xFD1D /* "i64x2.extract_lane", ImmSigs.LANEIDX */
#define WASM_OP_I64x2_REPLACE_LANE                                             \
    0xFD1E /* "i64x2.replace_lane", ImmSigs.LANEIDX */
#define WASM_OP_F32x4_EXTRACT_LANE                                             \
    0xFD1F /* "f32x4.extract_lane", ImmSigs.LANEIDX */
#define WASM_OP_F32x4_REPLACE_LANE                                             \
    0xFD20 /* "f32x4.replace_lane", ImmSigs.LANEIDX */
#define WASM_OP_F64x2_EXTRACT_LANE                                             \
    0xFD21 /* "f64x2.extract_lane", ImmSigs.LANEIDX */
#define WASM_OP_F64x2_REPLACE_LANE                                             \
    0xFD22 /* "f64x2.replace_lane", ImmSigs.LANEIDX */
...
#define WASM_OP_V128_LOAD8_LANE                                                \
    0xFD54 /* "v128.load8_lane", ImmSigs.MEMARG_LANEIDX */
#define WASM_OP_V128_LOAD16_LANE                                               \
    0xFD55 /* "v128.load16_lane", ImmSigs.MEMARG_LANEIDX */
#define WASM_OP_V128_LOAD32_LANE                                               \
    0xFD56 /* "v128.load32_lane", ImmSigs.MEMARG_LANEIDX */
#define WASM_OP_V128_LOAD64_LANE                                               \
    0xFD57 /* "v128.load64_lane", ImmSigs.MEMARG_LANEIDX */
#define WASM_OP_V128_STORE8_LANE                                               \
    0xFD58 /* "v128.store8_lane", ImmSigs.MEMARG_LANEIDX */
#define WASM_OP_V128_STORE16_LANE                                              \
    0xFD59 /* "v128.store16_lane", ImmSigs.MEMARG_LANEIDX */
#define WASM_OP_V128_STORE32_LANE                                              \
    0xFD5A /* "v128.store32_lane", ImmSigs.MEMARG_LANEIDX */
#define WASM_OP_V128_STORE64_LANE                                              \
    0xFD5B /* "v128.store64_lane", ImmSigs.MEMARG_LANEIDX */
...
#define WASM_OP_F32x4_DEMOTE_F64x2_ZERO                                        \
    0xFD5E /* "f32x4.demote_f64x2_zero", ImmSigs.NONE */
#define WASM_OP_F64x2_PROMOTE_F32x4                                            \
    0xFD5F /* "f64x2.demote_f32x4", ImmSigs.NONE */
...
#define WASM_OP_I8x16_NARROW_I16x8_S                                           \
    0xFD65 /* "i8x16.narrow_i16x8_s", ImmSigs.NONE */
#define WASM_OP_I8x16_NARROW_I16x8_U                                           \
    0xFD66 /* "i8x16.narrow_i16x8_u", ImmSigs.NONE */
...
#define WASM_OP_I16x8_EXTADD_PAIRWISE_I8x16_S                                  \
    0xFD7C /* "i16x8.extadd_pairwise_i8x16_s", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTADD_PAIRWISE_I8x16_U                                  \
    0xFD7D /* "i16x8.extadd_pairwise_i8x16_u", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTADD_PAIRWISE_I16x8_S                                  \
    0xFD7E /* "i16x8.extadd_pairwise_i8x16_s", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTADD_PAIRWISE_I16x8_U                                  \
    0xFD7F /* "i16x8.extadd_pairwise_i8x16_u", ImmSigs.NONE */

#define WASM_OP_I16x8_ABS 0xFD8001 /* "i16x8.abs", ImmSigs.NONE */
#define WASM_OP_I16x8_NEG 0xFD8101 /* "i16x8.neg", ImmSigs.NONE */
#define WASM_OP_I16x8_Q15MULR_SAT_S                                            \
    0xFD8201 /* "i16x8.q15mulr_sat_s", ImmSigs.NONE */
...
#define WASM_OP_I16x8_NARROW_I32x4_S                                           \
    0xFD8501 /* "i16x8.narrow_i32x4_s", ImmSigs.NONE */
#define WASM_OP_I16x8_NARROW_I32x4_U                                           \
    0xFD8601 /* "i16x8.narrow_i32x4_u", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTEND_LOW_I8x16_S                                       \
    0xFD8701 /* "i16x8.extend_low_i8x16_s", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTEND_HIGH_I8x16_S                                      \
    0xFD8801 /* "i16x8.extend_high_i8x16_s", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTEND_LOW_I8x16_U                                       \
    0xFD8901 /* "i16x8.extend_low_i8x16_u", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTEND_HIGH_I8x16_U                                      \
    0xFD8A01 /* "i16x8.extend_high_i8x16_u", ImmSigs.NONE */
...
#define WASM_OP_I16x8_EXTMUL_LOW_I8x16_S                                       \
    0xFD9C01 /* "i16x8.extmul_low_i8x16_s", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTMUL_HIGH_I8x16_S                                      \
    0xFD9D01 /* "i16x8.extmul_high_i8x16_s", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTMUL_LOW_I8x16_U                                       \
    0xFD9E01 /* "i16x8.extmul_low_i8x16_u", ImmSigs.NONE */
#define WASM_OP_I16x8_EXTMUL_HIGH_I8x16_U                                      \
    0xFD9F01 /* "i16x8.extmul_high_i8x16_u", ImmSigs.NONE */
...
/* placeholder A5 */
/* placeholder A6 */
#define WASM_OP_I32x4_EXTEND_LOW_I16x8_S                                       \
    0xFDA701 /* "i32x4.extend_low_i16x8_s", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTEND_HIGH_I16x8_S                                      \
    0xFDA801 /* "i32x4.extend_high_i16x8_s", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTEND_LOW_I16x8_U                                       \
    0xFDA901 /* "i32x4.extend_low_i16x8_u", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTEND_HIGH_I16x8_U                                      \
    0xFDAA01 /* "i32x4.extend_high_i16x8_u", ImmSigs.NONE */
...
#define WASM_OP_I32x4_DOT_I16x8_S                                              \
    0xFDBA01 /* "i32x4.dot_i16x8_s", ImmSigs.NONE */
/* placeholder BB */
#define WASM_OP_I32x4_EXTMUL_LOW_I16x8_S                                       \
    0xFDBC01 /* "i32x4.extmul_low_i16x8_s", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTMUL_HIGH_I16x8_S                                      \
    0xFDBD01 /* "i32x4.extmul_high_i16x8_s", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTMUL_LOW_I16x8_U                                       \
    0xFDBE01 /* "i32x4.extmul_low_i16x8_u", ImmSigs.NONE */
#define WASM_OP_I32x4_EXTMUL_HIGH_I16x8_U                                      \
    0xFDBF01 /* "i32x4.extmul_high_i16x8_u", ImmSigs.NONE */
...
/* placeholder C5 */
/* placeholder C6 */
#define WASM_OP_I64x2_EXTEND_LOW_I32x4_S                                       \
    0xFDC701 /* "i64x2.extend_low_i32x4_s", ImmSigs.NONE */
#define WASM_OP_I64x2_EXTEND_HIGH_I32x4_S                                      \
    0xFDC801 /* "i64x2.extend_high_i32x4_s", ImmSigs.NONE */
#define WASM_OP_I64x2_EXTEND_LOW_I32x4_U                                       \
    0xFDC901 /* "i64x2.extend_low_i32x4_u", ImmSigs.NONE */
#define WASM_OP_I64x2_EXTEND_HIGH_I32x4_U                                      \
    0xFDCA01 /* "i64x2.extend_high_i32x4_u", ImmSigs.NONE */
...
#define WASM_OP_I64x2_EXTMUL_LOW_I32x4_S                                       \
    0xFDDC01 /* "i64x2.extmul_low_i32x4_s", ImmSigs.NONE */
#define WASM_OP_I64x2_EXTMUL_HIGH_I32x4_S                                      \
    0xFDDD01 /* "i64x2.extmul_high_i32x4_s", ImmSigs.NONE */
#define WASM_OP_I64x2_EXTMUL_LOW_I32x4_U                                       \
    0xFDDE01 /* "i64x2.extmul_low_i32x4_u", ImmSigs.NONE */
#define WASM_OP_I64x2_EXTMUL_HIGH_I32x4_U                                      \
    0xFDDF01 /* "i64x2.extmul_high_i32x4_u", ImmSigs.NONE */
...
#define WASM_OP_I32x4_TRUNC_SAT_F32x4_S                                        \
    0xFDF801 /* "i32x4.trunc_sat_f32x4_s", ImmSigs.NONE */
#define WASM_OP_I32x4_TRUNC_SAT_F32x4_U                                        \
    0xFDF901 /* "i32x4.trunc_sat_f32x4_u", ImmSigs.NONE */
#define WASM_OP_F32x4_TRUNC_SAT_I32x4_S                                        \
    0xFDFA01 /* "f32x4.trunc_sat_i32x4_s", ImmSigs.NONE */
#define WASM_OP_F32x4_TRUNC_SAT_I32x4_U                                        \
    0xFDFB01 /* "f32x4.trunc_sat_i32x4_u", ImmSigs.NONE */

#define WASM_OP_I32x4_TRUNC_SAT_F64x2_S_ZERO                                   \
    0xFDFC01 /* "i32x4.trunc_sat_f64x2_s_zero", ImmSigs.NONE */
#define WASM_OP_I32x4_TRUNC_SAT_F64x2_U_ZERO                                   \
    0xFDFD01 /* "i32x4.trunc_sat_f64x2_u_zero", ImmSigs.NONE */
#define WASM_OP_F64x2_CONVERT_LOW_I32x4_S                                      \
    0xFDFE01 /* "f64x2.convert_low_i32x4_s", ImmSigs.NONE */
#define WASM_OP_F64x2_CONVERT_LOW_I32x4_U                                      \
    0xFDFF01 /* "f64x2.convert_low_i32x4_u", ImmSigs.NONE */
