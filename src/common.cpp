...
void encode_i32leb(bytedeque &bdeq, int32_t val) { ENCODE_BODY(SIGNED); }

void encode_u32leb(bytedeque &bdeq, uint32_t val) { ENCODE_BODY(UNSIGNED); }

void encode_i64leb(bytedeque &bdeq, int64_t val) { ENCODE_BODY(SIGNED); }

void encode_u64leb(bytedeque &bdeq, uint64_t val) { ENCODE_BODY(UNSIGNED); }
...
void encode_u8(bytedeque &bdeq, uint8_t val) { bdeq.push_back(val); }

void encode_u32(bytedeque &bdeq, uint32_t val) { ENCODE_RAW(val); }

void encode_u64(bytedeque &bdeq, uint64_t val) { ENCODE_RAW(val); }
...
void preencode_u8(bytedeque &bdeq, uint8_t val) { bdeq.push_front(val); }
