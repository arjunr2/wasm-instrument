...
/* All the following instructions should never be instantiated explicitly, only
 * by parser */
class InstBase {
  private:
    Opcode_t opcode;
  ...
  public:
    InstBase(Opcode_t opcode) : opcode(opcode) {
        ...
        // We can't easily set the pc when we create the instruction since we
        // need to backtrack the variable length opcode. Instead set this after
        // creation with setOrigPc
        this->orig_pc = -1;
    }
    ...
    inline bool isImmType(opcode_imm_type oit) {
        return (this->imm_type == oit);
    }
    ...
    virtual std::string to_string(WasmModule &module) const {
...
class ImmNoneInst : public InstBase {
  public:
    ...
    ImmNoneInst(Opcode_t opcode) : InstBase(opcode) {};
...
class ImmBlocktInst : public InstBase {
  ...
  public:
    ...
    inline int64_t getType() const { return type; }

    // void decode_imm (WasmModule &module , buffer_t &buf) const override;
    void encode_imm(WasmModule &module, bytedeque &bdeq) const override;
    std::string to_string(WasmModule &module) const override;
};
...
class ImmLabelInst : public InstBase {
  ...
  public:
    ...
    ImmLabelInst(Opcode_t opcode, uint32_t idx) : InstBase(opcode), idx(idx) {}

    inline uint32_t getLabel() const { return idx; }
...
class ImmLabelsInst : public InstBase {
  ...
  public:
    ...
    inline uint32_t getDefLabel() const { return def_idx; }
...
class ImmFuncInst : public InstBase {
  ...
  public:
    ...
    inline FuncDecl *getFunc() const { return func; }
...
class ImmSigTableInst : public InstBase {
  ...
  public:
    ...
    inline SigDecl *getSig() const { return sig; }
    inline TableDecl *getTable() const { return table; }
...
class ImmLocalInst : public InstBase {
  ...
  public:
    ...
    ImmLocalInst(Opcode_t opcode, uint32_t idx) : InstBase(opcode), idx(idx) {}

    inline uint32_t getLocal() const { return idx; }
...
class ImmGlobalInst : public InstBase {
  ...
  public:
    ...
    inline GlobalDecl *getGlobal() const { return global; }
...
class ImmMemargInst : public InstBase {
  ...
  public:
    ...
    inline uint32_t getAlign() const { return align; }
    inline MemoryDecl *getMemory() const { return mem; }
...
class ImmTagInst : public InstBase {
  ...
  public:
    ...
    ImmTagInst(Opcode_t opcode) : InstBase(opcode) {}
...
class ImmF32Inst : public InstBase {
  ...
  public:
    ...
    ImmF32Inst(Opcode_t opcode, float value) : InstBase(opcode), value(value) {}
...
class ImmRefnulltInst : public InstBase {
  ...
  public:
    ...
    inline wasm_type_t getType() const { return type; }
...
class ImmDataMemoryInst : public InstBase {
  ...
  public:
    ...
    inline DataDecl *getData() const { return data; }
    inline MemoryDecl *getMemory() const { return mem; }
...
class ImmMemorycpInst : public InstBase {
  ...
  public:
    ...
    inline MemoryDecl *getDstMemory() const { return dst; }
    inline MemoryDecl *getSrcMemory() const { return src; }
...
class ImmTablecpInst : public InstBase {
  ...
  public:
    ...
    inline TableDecl *getDstTable() const { return dst; }
    inline TableDecl *getSrcTable() const { return src; }
...
class ImmV128Inst : public InstBase {
  ...
  public:
    ...
    inline V128_t getValue() const { return value; }
...
class ImmLaneidxInst : public InstBase {
  ...
  public:
    ...
    inline Laneidx_t getLaneidx() const { return idx; }
...
class ImmLaneidx16Inst : public InstBase {
  ...
  public:
    ...
    inline Laneidx16_t getLaneidx16() const { return idxs; }
...
class ImmMemargLaneidxInst : public InstBase {
  ...
  public:
    ...
    ImmMemargLaneidxInst(Opcode_t opcode, uint32_t align, uint32_t offset,
                         MemoryDecl *mem, Laneidx_t laneidx)
        : InstBase(opcode), align(align), offset(offset), mem(mem),
          laneidx(laneidx) {}
    ...
    inline uint32_t getAlign() const { return align; }
    inline MemoryDecl *getMemory() const { return mem; }
    inline Laneidx_t getLaneidx() const { return laneidx; }
...
#define ICS(cs, clsname)                                                       \
    case cs:                                                                   \
        instptr.reset(new clsname(module, opcode, buf));                       \
        instptr->setOrigPc(pc);                                                \
        break;
